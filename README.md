...
AI Posting 기능은 최근 기사 내용과 관련 게시물을 분석해 블로그 포스트를 자동 생성하고, 관련 이미지를 검색해 포스트에 간편하게 추가할 수 있습니다.
</div>
<br/>
...
- AI 포스팅: 네이버 뉴스 API와 블로그 API로 특정 키워드의 최근 이틀 내의 기사 및 포스팅들을 수집하고, OpenAI API와 전문 블로거용 프롬프트를 활용해 자동으로 블로그 게시글을 생성합니다. 클립보드 복사 기능으로 에디터에 바로 붙여넣을 수 있습니다.<br>
