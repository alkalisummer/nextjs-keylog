...
import React, { useRef, useEffect, ReactNode, useMemo, useCallback } from 'react';
...
export const InfiniteScroll = React.memo<InfiniteScrollProps>(
  ({
    width = '30rem',
    maxHeight = '100%',
    ...
    `,
      ...
      [maxHeight, width, itemMinWidth, itemMinHeight, negativeMargin, isTilted, tiltDirection],
    );
